module.exports = (values) => {
	...
	* {
    ...
    <div class="rela-block page">
        ...
        <div class="side-bar">
			...
			<p class="mb-1"><span style="padding-right:10px;"><i class="fas fa-phone-square-alt"></i></span>${phoneNumber}</p>
			`;
  ...
  if (values.codeForces != "" && values.codeForces != null)
    htmlTemplate += `<p class="rela-block social mb-4"><span style="padding-right: 15px; font-size="20px;"><i class="fas fa-info-circle"></i></span>${values.codeForces}</p>`;
  if (values.location != "" && values.location != null)
    htmlTemplate += `<p class="rela-block social mb-4"><span style="padding-right: 15px; font-size="20px;"><i class="fa fa-map-marker"></i></span>${values.location}</p>`;
  htmlTemplate += `<div class="rela-block caps greyed">Technical Strengths</div>`;
  if (values.technicalSkill != "" && values.technicalSkill != null)
    htmlTemplate += `
			<p class="text-muted light mt-0 mb-1 font-weight-bold">${values.technicalSkill}}</p>`;
  htmlTemplate += `<div class="rela-block caps greyed">Education</div>`;
  if (university != "" && university != null)
    htmlTemplate += `<h3 class="mb-0">${university}</h3>
			<p class="text-muted light mt-0 mb-1">${fromYear}<span class="mx-2">to</span>${toYear}</p>
			<p class="justified mt-0 mb-1" style="font-size: 17px;">${qualification}</p>
			<p class="justified mt-0 mb-3" style="font-size: 17px;">${description}</p>`;
  ...
  if (organization != "" && organization != null)
    htmlTemplate += `<h3>${organization}</h3>
            <p class="text-muted light mt-1 mb-2" style="font-size:17px;">${position}<span class="ml-5 pl-5">Duration: ${exDuration}</span></p>
            <p class="justified" style="font-size:17px;">${exDescription}</p>`;

  if (organization2 != "" && organization2 != null)
    htmlTemplate += `<h3>${organization2}</h3>
            <p class="text-muted light mt-1 mb-2" style="font-size:17px;">${position2}<span class="ml-5 pl-5">Duration: ${exDuration2}</span></p>
            <p class="justified" style="font-size:17px;">${exDescription2}</p>`;
  ...
  if (title != "" && title != null)
    htmlTemplate += `
			<h3>${title}</h3>
            <p class="light mt-1 mb-2" style="font-size:17px;"><span class="mr-2"><i class="fas fa-link"></i></span>${projectLink}</p>
            <p class="justified" style="font-size:17px;">${projectDescription}</p>
  ...
  if (title2 != "" && title2 != null)
    htmlTemplate += `
            <h3>${title2}</h3>
            <p class="light mt-1 mb-2" style="font-size:17px;"><span class="mr-2"><i class="fas fa-link"></i></span>${plink2}</p>
            <p class="justified" style="font-size:17px;">${pDescription2}</p>`;

  htmlTemplate += `<div class="rela-block caps greyed extra-curr">Extra-curricular activity</div>`;
  if (values.extraTitle != "" && values.extraTitle != null)
    htmlTemplate += `
				<h3>${values.extraTitle}</h3>
				<p class="justified" style="font-size:17px;">${values.extraDescription}</p>`;
  if (values.extraTitle1 != "" && values.extraTitle1 != null)
    htmlTemplate += `
					<h3>${values.extraTitle1}</h3>
					<p class="justified" style="font-size:17px;">${values.extraDescription1}</p>`;
  htmlTemplate += `<div class="rela-block caps greyed">Selected courses</div>`;
  if (values.courseName != "" && values.courseName != null)
    htmlTemplate += `
				<h3>${values.courseName}</h3>
				<p class="justified" style="font-size:17px;">${values.courseDescription}</p>`;
  if (values.courseName1 != "" && values.courseName1 != null)
    htmlTemplate += `
					<h3>${values.courseName1}</h3>
					<p class="justified" style="font-size:17px;">${values.courseDescription1}</p>
